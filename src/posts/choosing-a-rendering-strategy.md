...
<script>
    import StaticRenderingImg from '$lib/assets/blog/rendering-strategies/static-rendering.png';
    import ServerRenderingImg from '$lib/assets/blog/rendering-strategies/server-rendering.png';
    import ClientRenderingImg from '$lib/assets/blog/rendering-strategies/client-rendering.png';
</script>
...
<img src={StaticRenderingImg} alt="Example of static rendering" />
...
<img src={ServerRenderingImg} alt="Example of server-side rendering" />
