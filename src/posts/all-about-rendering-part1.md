...
<script>
    import RenderTaskImg from '$lib/assets/blog/about-rendering-1/render-task.png';
    import MainThreadImg from '$lib/assets/blog/about-rendering-1/main-thread-execution.png';
    import PerfRecordImg from '$lib/assets/blog/about-rendering-1/performance-record.png';
</script>
...
<img src={RenderTaskImg} alt="The render task visualized" />
...
<img src={MainThreadImg} alt="JavaScript execution summary" />
...
<html lang="en">
	...
	<body>
		<h1>Hello World</h1>
		<p>
			Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem animi voluptate
			tempore magnam nemo minima molestias expedita, mollitia, numquam sit nobis? Animi quasi
			praesentium nemo ex cupiditate eum fugiat iste.
		</p>
		<ul>
			<li>item 1</li>
			<li>item 2</li>
...
<img src={PerfRecordImg} alt="Performance recording from browser" />
